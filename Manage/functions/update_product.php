...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql_update = "UPDATE products SET product_name = ?, product_condition = ?, price = ?, color = ?, product_description = ?, top_features = ?, stand_out_features = ?";
    ...
    // Bind parameters
    if ($product_image) {
        $stmt_update->bind_param("ssisssssi", $product_name, $product_condition, $price, $color, $product_description, $top_features, $stand_out_features, $product_image, $product_id);
    } else {
        $stmt_update->bind_param("ssissssi", $product_name, $product_condition, $price, $color, $product_description, $top_features, $stand_out_features, $product_id);
    }
