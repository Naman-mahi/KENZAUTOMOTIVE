...
<script>
    ...
    const ImageBASE_URL = 'https://api.intencode.com/uploads/ProductThumbnail/';
            ...
            const item = `
                <div class="col-12 col-md-6 col-lg-4 item pb-3 search">
                    <a href="viewproduct.php?product_id=${product.product_id}" class="text-decoration-none">
                        <div class="car-card">
                            <div class="car-img">
                                <img src="${ImageBASE_URL}${product.product_image}" alt="${product.product_name}" class="img-fluid">
                            </div>
                            <div class="car-content">
                                <div class="car-content-inner">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <p class="car-price mb-0">INR ${product.price}</p>
