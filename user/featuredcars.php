            ...
            <div class="col-lg-3 col-md-4">
                ...
                <div class="collapse d-md-block" id="filterPanel">
                    <div class="accordion" id="filterAccordion">
                                ...
                                <div class="accordion-body">
                                    <div class="d-flex align-items-center">
                                        <div class="input-group flex-grow-1">
                                            ...
                                            <input type="range" class="form-range" id="yearRange" min="2000" max="2024" step="1" value="2000">
                                        </div>
                                    </div>
                                    <!-- Display selected year range -->
                                    <div class="d-flex justify-content-between mt-2">
                                        <span id="yr_from" class="text-muted">2000</span> <!-- Display the "From" year -->
                                        <span id="yr_to" class="text-muted">2024</span> <!-- Display the "To" year -->
                                    </div>
                                    <!-- Optional: Show a hint message -->
                                    <div id="yr_hint" class="mt-2"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- kilometers Driven Accordion Item -->
                        <div class="accordion-item">
                            ...
                            <div id="collapseMileage" class="accordion-collapse collapse show" aria-labelledby="headingMileage">
                                <div class="accordion-body">
                                    <div class="d-flex align-items-center">
                                        <div class="input-group flex-grow-1">
                                            <!-- Slider for Mileage -->
                                            <input type="range" class="form-range" id="mileageRange" min="0" max="200000" step="1000" value="0">
                                            <!-- Tooltip that will follow the slider thumb -->
                                            <div id="mileageTooltip" class="slider-tooltip">0 km</div>
                                        </div>
                                    </div>
                                    <!-- Display selected mileage range -->
                                    <div class="d-flex justify-content-between mt-2">
                                        <span id="ml_from" class="text-muted">0 km</span> <!-- Display the "From" mileage -->
                                        <span id="ml_to" class="text-muted">200,000 km</span> <!-- Display the "To" mileage -->
                                    </div>
                                    <!-- Optional: Show a hint message -->
                                    <div id="ml_hint" class="mt-2"></div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    function fetchProducts() {
        $.ajax({
            url: `${API_BASE_URL}/featured-products`, // Use API_BASE_URL variable for the base URL
            type: 'GET',
    ...
    async function displayProducts(products) {
        ...
        for (let i = 0; i < products.length; i++) {
            ...
            // Safe check for combined_attributes before calling .find()
            const combinedAttributes = product.combined_attributes || [];

            const mileage = combinedAttributes.find(attr => attr.pf_name === "Mileage (MPG)")?.value || 'N/A';
            const fuelType = combinedAttributes.find(attr => attr.pf_name === "Fuel Type")?.value || 'N/A';
            const transmissionType = combinedAttributes.find(attr => attr.pf_name === "Transmission Type")?.value || 'N/A';
